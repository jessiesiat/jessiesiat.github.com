<template>
  <div class="flex flex-col justify-center items-center h-screen">
    <h1 class="text-8xl font-semibold text-gray-400">404</h1>
    <h2 class="text-2xl font-semibold mt-2 text-gray-400">Page Not Found</h2>
    <a href="/" class="mt-8 text-sm flex space-x-1 link">
